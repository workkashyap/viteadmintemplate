          ...
          <div class="row mt-3">
            <div class="col-md-6">
              ...
              <div id="trendsBtnContainer" class="mt-3 text-center">
                <button id="trendsBtn" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#trendModal">TRENDS</button>
              </div>
            </div>
            <div class="col-md-6">
...
export default {
  onMounted(() => {
      // Listen to the shown.bs.modal event and call renderLineCharts when the Trend Modal is shown
      $('#trendModal').on('shown.bs.modal', renderLineCharts);
    });
  name: 'ChartExample',
  setup() {
