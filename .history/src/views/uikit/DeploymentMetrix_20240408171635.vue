    ...
    <div class="col-12">
      <div class="card">
        ...
        <DataTable
          ...
          :globalFilterFields="['spk', 'REPO', 'branchtype', 'version', 'Enviroment', 'Build', 'Initiator', 'Duration', 'JobUrl']"
        >
          ...
          <Column field="Status" header="Status">
            <template #body="{ data }">
              <Badge :severity="getStatusBadgeSeverity(data.Status)" :value="data.Status" />
            </template>
          </Column>
          <Column field="JobUrl" header="Job URL"></Column>
        </DataTable>
