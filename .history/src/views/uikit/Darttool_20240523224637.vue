...
const showTrends = () => {
  ...
  modalContent.value = [
    { label: 'Priority 1', source: 'Source 1' },
    { label: 'Priority 2', source: 'Source 2' },
    { label: 'Priority 3', source: 'Source 3' },
    { label: 'Priority 4', source: 'Source 4' },
    { label: 'Priority 5', source: 'Source 5' }
  ];
  showModal(); // Show modal after preparing data
};
</script>
