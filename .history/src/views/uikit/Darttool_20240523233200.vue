<template>
  <div class="container mt-5">
          ...
          <div class="row mt-3">
            <div class="col-md-6">
              ...
              <div id="trendsBtnContainer" class="mt-3 text-center" :class="{ active: showTrendsButton }">
                <button id="trendsBtn" class="btn btn-outline-primary" @click="showTrendsModal">TRENDS</button>
              </div>
            </div>
            <div class="col-md-6">
    ...
    <!-- Trend Modal -->
    <div class="modal fade" id="trendModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Priority Trends</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <!-- Line charts for each priority -->
...
export default {
  ...
  setup() {
    ...
    const showTrendsModal = () => {
      ...
      $('#trendModal').modal('show'); // Show the trend modal
      renderLineCharts(); // Render line charts
    };
