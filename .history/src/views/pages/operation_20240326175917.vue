...
const filterUsers = (searchTerm) => {
  ...
  filteredUsers.value = users.value.filter(user => {
    return (
      ...
      (user.address?.city && user.address.city.toLowerCase().includes(lowerCaseSearchTerm)) ||
...
const editButton = (rowData) => {
  return <Button icon="pi pi-pencil" onClick={() => openEdit(rowData)} />;
};

const openEdit = (rowData) => {
  // Open your edit dialog here and populate the fields with the data from `rowData`
};
